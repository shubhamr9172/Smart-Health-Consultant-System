...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2024 at 12:09 PM
...
('4ef1dbe95fe4b1128ede9b16ff2dcacfc6fd6ab8', 'Sys Admin', 'shubhamreddy9172@gmail.com', '939d61194ad50f66993a57622631a05ce14427c4', '2020-09-11 00:19:22', NULL);
...
CREATE TABLE `consultations` (
  `consul_id` varchar(191) NOT NULL,
  `consul_code` varchar(191) NOT NULL,
  `member_id` varchar(191) NOT NULL,
  `member_name` varchar(191) NOT NULL,
  `member_phone` varchar(191) NOT NULL,
  `doc_id` varchar(191) NOT NULL,
  `doc_name` varchar(191) NOT NULL,
  `consul_details` longtext NOT NULL,
  `consul_status` varchar(191) NOT NULL,
...
CREATE TABLE `knowledge_base` (
  ...
  `kb_title` varchar(191) NOT NULL,
  `kb_desc` longtext NOT NULL,
...
CREATE TABLE `medical_experts` (
  ...
  `doc_bio` longtext NOT NULL,
  `doc_photo` varchar(191) NOT NULL,
  `month_joined` varchar(200) NOT NULL,
  `doc_status` varchar(191) NOT NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('bb1342763c0f5f4236acae5620e22a', 'XJOEF-19482', 'shubham', 'mayurreddy286@gmail.com', '9172587538', '939d61194ad50f66993a57622631a05ce14427c4', '', '', 'Feb', 'Verified', '2024-02-05 11:05:12.406582', NULL),
...
CREATE TABLE `members` (
  ...
  `member_password` varchar(191) NOT NULL,
  `member_adr` varchar(191) NOT NULL,
  `month_joined` varchar(200) NOT NULL,
  `member_pic` varchar(191) NOT NULL,
  `member_package` varchar(191) NOT NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `membership_payments` (
  ...
  `pay_code` varchar(191) NOT NULL,
  `pay_method` varchar(191) NOT NULL,
  `pay_amt` varchar(191) NOT NULL,
  `member_id` varchar(191) NOT NULL,
  `member_package` varchar(191) NOT NULL,
...
CREATE TABLE `packages` (
  ...
  `package_price` varchar(191) NOT NULL,
